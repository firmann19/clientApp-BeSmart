        ...
        <div className="px-6 items-center mt-8 p-8">
            ...
            <div className="flex gap-18 mx-20 justify-between">
                ...
                <div className='bg-primary-color items-center p-8 text-center w-80 h-96 rounded-xl filter-sd'>
                    ...
                    <h1 className='text-2xl font-bold text-white my-6'>Mobile Development</h1>
                    <p className='text-center text-white'>Belajar membangun aplikasi android  untuk menjadi
                        developer  android
                        standar global."</p>
                </div>
                <CourseItem
